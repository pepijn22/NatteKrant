                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="m_widget4_tab1_content">
                                            ...
                                            <div class="m-widget1" style="padding: 0;">
                                                ...
                                                <?php 
                                                    $query = "SELECT 
                                                    naam, verkoopprijs - minimum_inkoopprijs AS winst
                                                FROM
                                                    product AS p
                                                        JOIN
                                                    (SELECT 
                                                        p.product_id, MIN(inkoopprijs) AS minimum_inkoopprijs
                                                    FROM
                                                        inkoop AS i
                                                    LEFT JOIN leverancier AS l ON i.Leverancier_leverancier_id = l.leverancier_id
                                                    LEFT JOIN product AS p ON p.product_id = i.Product_product_id
                                                    GROUP BY i.Product_product_id) AS mp ON mp.product_id = p.product_id
                                                ORDER BY winst DESC";
                                               ...
                                               <div class="m-widget1__item">
                                                    <div class="row m-row--no-padding align-items-center">
                                                        <div class="col">
                                                            <h3 class="m-widget1__title"><?= $row[naam] ?></h3>
                                                        </div>
                                                        <div class="col m--align-right">
                                                            <span class="m-widget1__number m--font-info">&euro;<?= $row[winst] ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php } ?>
